package D.DataStructureAndAlgorithms.quicksort;

import java.util.Arrays;

/**
 * Created by slavkurochkin on 2/19/17.
 */
public class App {
    ...
    public static int partition(int[] inputArray, int start, int end) {
        ...
        //put the pivot value in the scorrect slot next
        int ival = inputArray[i+1];
        inputArray[end] = ival;
        inputArray[i+1] = pivot; // here, pivot value is placed in the correct slot of array
        return i+1;
    }
}
